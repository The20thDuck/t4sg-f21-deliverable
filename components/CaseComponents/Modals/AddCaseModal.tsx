...
mutation InsertCaseMutation($description: String = "", $name: String = "", $status: String = "", $category_id: Int = 1) {
  insert_cases_one(object: {category_id: $category_id, name: $name, description: $description, status: $status}) {
    description,
    name,
    status,
    category_id,
